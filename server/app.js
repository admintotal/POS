...
router.route('/clientes2').get(apiKeyMiddleware, api.clientes2)
router.route('/clientes/:id').get(apiKeyMiddleware, api.cliente)
router.route('/productos').get(apiKeyMiddleware, api.productos)
router.route('/productos2').get(apiKeyMiddleware, api.productos2)
...
router.route('/cambiar-serie-ventas').post(apiKeyMiddleware, api.cambiarStatusVentas)
